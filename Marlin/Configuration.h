...
#define CUSTOM_MACHINE_NAME "RepRapPro Huxley"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "40b544dd-9f50-4276-a216-86d85877dc36"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 49.52
  #define DEFAULT_Ki 4.69
  #define DEFAULT_Kd 130.82
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 2), (Y_MIN_POS + 2), 20 }
